...
module.exports = function (app) {
  app
    ...
    .put(async function (req, res) {
      ...
      console.log("mongodb:", req.body);
      console.time("[PUT] - /api/threads/:board");
      const thread = await Thread.findByIdAndUpdate(thread_id, { reported: true, bumped_on:  Date.now() }, { new: true });
    ...
    .delete(async function (req, res) {
      try {
        ...
        const reply = await Thread.findOneAndDelete({
          _id: thread_id,
          delete_password,
        });
